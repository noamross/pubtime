...
dat = subset(pubtimes, journal == "PeerJ" & accepttime > 0)
...
#  geom_jitter(position = position_jitter(width = .05), size=2) +
  ...
  theme(legend.position="none",
        ...
        ggtitle("Submit-to-Accept times of Ecology articles in PeerJ") +
...
ggplot(dat, aes(y = printtime, x = journal, fill=journal, col=journal)) + 
  ...
  theme(legend.position="none",
        ...
        axis.title=element_text(size=18),
        axis.text=element_text(color="black",size=13)) +
        ggtitle("Accept-to-Publish times of Ecology articles in PeerJ") +
  xlab("") + ylab("Days")
...
ggplot(dat, aes(x = online, y= accepttime)) +
  ...
  theme(legend.position="bottom",
        ...
        axis.title=element_text(size=18),
        axis.text=element_text(color="black",size=13)) +
    ggtitle("Received-to-Accept times over time at PeerJ")
...
ggplot(eds, aes(x = N, y=Mean)) + 
  ...
  ggtitle("Editor handling times by experience in PeerJ")
